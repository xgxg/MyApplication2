...
public class TitlePopup extends PopupWindow {
	 ...
	 */
	private void initUI(){
		mListView = (AutoWidthListView) getContentView().findViewById(R.id.title_list);
	...
	private void populateActions(){
		...
		mListView.setAdapter(new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (convertView == null){
					convertView = LayoutInflater.from(mContext).inflate(R.layout.item_title_qrcode, null);
				}
